...
const (
	Analytics_GetStatistics_FullMethodName = "/analytics.Analytics/GetStatistics"
)
...
func (c *analyticsClient) GetStatistics(ctx context.Context, in *StatisticsRequest, opts ...grpc.CallOption) (*StatisticsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StatisticsResponse)
	err := c.cc.Invoke(ctx, Analytics_GetStatistics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalyticsServer) GetStatistics(context.Context, *StatisticsRequest) (*StatisticsResponse, error) {
...
func _Analytics_GetStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StatisticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServer).GetStatistics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Analytics_GetStatistics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServer).GetStatistics(ctx, req.(*StatisticsRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Analytics_GetStatistics_Handler,
		},
	},
